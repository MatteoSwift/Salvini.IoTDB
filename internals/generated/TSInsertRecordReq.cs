...
internal partial class TSInsertRecordReq : TBase
{
    ...
    public TSInsertRecordReq(long sessionId, string prefixPath, List<string> measurements, byte[] values, long timestamp) : this()
    {
